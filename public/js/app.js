...
(0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
  ...
  title: function title(_title) {
    return "".concat(_title, " - Trip Ticket v0.5");
  },
...
var map = {
	"./Approval": [
		...
		"/js/vendor",
		"resources_js_Pages_Approval_vue"
	],
	"./Approval.vue": [
		"./resources/js/Pages/Approval.vue",
		"/js/vendor",
	...
	"./UserView": [
		...
		"/js/vendor",
		"resources_js_Pages_UserView_vue"
	],
	"./UserView.vue": [
		"./resources/js/Pages/UserView.vue",
		"/js/vendor",
